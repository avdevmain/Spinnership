...
namespace MoreMountains.CorgiEngine
{
	...
	public class LevelManager : MMSingleton<LevelManager>
	{
		...
		/// this list is obsolete and won't be used anymore. Move your data to the new PointsOfEntry list
		[Tooltip("a list of all the points of entry for this level. this list is obsolete and won't be used anymore. Move your data to the new PointsOfEntry list")]
		[FormerlySerializedAs("PointsOfEntry")]
		public Transform[] PointsOfEntryLegacy;
